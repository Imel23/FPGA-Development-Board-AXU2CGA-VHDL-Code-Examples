...
#
# Script generated by Vivado on Sat Jun 07 00:04:01 CEST 2025
...
# script info
echo -e "rom_ip.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot rom_ip xil_defaultlib.rom_ip xil_defaultlib.glbl -log elaborate.log
}
