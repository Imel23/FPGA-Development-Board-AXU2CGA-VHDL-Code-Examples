...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../led.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/udemy/vhdl_projects/led/led.cache/compile_simlib/xcelium"
  fi
