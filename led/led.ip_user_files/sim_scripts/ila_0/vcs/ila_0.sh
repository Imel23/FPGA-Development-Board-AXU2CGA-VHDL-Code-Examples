...
#
# Script generated by Vivado on Fri Jun 06 10:04:01 CEST 2025
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../led.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/udemy/vhdl_projects/led/led.cache/compile_simlib/vcs"
  fi
